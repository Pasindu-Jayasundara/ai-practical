...
anotatedImage = draw_landmarks_on_image(image.numpy_view(), result)
colorCorrectedImage = cv2.cvtColor(anotatedImage, cv2.COLOR_RGB2BGR)
cv2.imshow('Annotated Image', colorCorrectedImage)
cv2.waitKey(0)